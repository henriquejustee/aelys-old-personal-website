        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="mr-auto flex bg-gradient-to-r from-slate-800 to-transparent p-10  rounded opacity-90">
            <div className="">
              ...
              <h3 className="text-white font-bold">When I first interacted with a computer, I was always been curious about how things are made from scratch, whether it be hardware or the very pixel you see in screens, that's when I started to slowly fall in love with tech.</h3>
              <p className="text-white pt-2">A hot take, I firmly believe that in order to hone your craft, you'll have to sacrifice some of your free time. Fortunately, in my case, programming is my hobby and it just happens to be my profession.</p>
              <p className="text-white pt-2">I'm a programming and information technology student with two years of experience
